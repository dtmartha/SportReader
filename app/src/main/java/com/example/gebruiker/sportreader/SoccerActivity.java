...
public class SoccerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            Intent i = new Intent(SoccerActivity.this, HomePageActivity.class);
            startActivity(i);
        } else if (id == R.id.soccer) {


        } else if (id == R.id.american_football) {
            Intent i = new Intent(SoccerActivity.this, AmericanFootballActivity.class);
            startActivity(i);

        } else if (id == R.id.cricket) {
            Intent i = new Intent(SoccerActivity.this, CricketActivity.class);
            startActivity(i);
    ...
    public Loader<ArrayList<Article>> onCreateLoader(int id, Bundle args) {
        ...
        return new ArticleLoader(this, URL_SOCCER);
    }
