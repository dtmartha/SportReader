...
public class CricketActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            Intent i = new Intent(CricketActivity.this, HomePageActivity.class);
            startActivity(i);
        } else if (id == R.id.soccer) {
            Intent i = new Intent(CricketActivity.this, SoccerActivity.class);
            startActivity(i);


        } else if (id == R.id.american_football) {
            Intent i = new Intent(CricketActivity.this, AmericanFootballActivity.class);
            startActivity(i);
    ...
    public Loader<ArrayList<Article>> onCreateLoader(int id, Bundle args) {
        ...
        return new ArticleLoader(this, URL_CRICKET);
    }
